...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    includes: [
  "tourIncludes.meetAtElGounaMarina",
  "tourIncludes.sailingInElGounaSea",
  "tourIncludes.swimmingAndSnorkelingStop",
  "tourIncludes.relaxingTimeOnDeck",
  "tourIncludes.softDrinksAndWaterIncluded",
  "tourIncludes.returnToMarina",
],
  ...
  },
  {
    ...
    includes: [
  "tourIncludes.elMinaMosque",
  "tourIncludes.hurghudaMarina",
  "tourIncludes.localBazaars",
  "tourIncludes.walkingThroughHurghudaStreets",
  "tourIncludes.discoveringLocalLifeAndCulture",
],
  ...
  },
  {
    ...
    includes: [
  "tourIncludes.marineAnimals",
  "tourIncludes.gallonsOfWater",
  "tourIncludes.marineExhibitions",
  "tourIncludes.underwaterTunnelWalking",
  "tourIncludes.aquariumEntry",
  "tourIncludes.rainforestArea",
  "tourIncludes.smallZoo",
],
  ...
  },
  {
    ...
    includes: [
  "tourIncludes.toursAlongSandyBeaches",
  "tourIncludes.suitableForBeginnersAndExperienced",
  "tourIncludes.professionalTrainers",
  "tourIncludes.basicHorseRidingTraining",
  "tourIncludes.ridingPaceAdjusted",
],
  ...
  },
  {
    ...
    includes: [
  "tourIncludes.pickupFromHurghudaAirport",
  "tourIncludes.dropOffAtHotelsResorts",
  "tourIncludes.elGounaTransfers",
  "tourIncludes.makadiBayTransfers",
  "tourIncludes.sahlHasheeshTransfers",
  "tourIncludes.comfortablePrivateOrSharedVehicles",
],
  ...
  },
  {
    ...
    includes: [
  "tourIncludes.variousCruiseOptions",
  "tourIncludes.professionalService",
  "tourIncludes.entertainmentIncluded",
  "tourIncludes.mealsIncluded",
],
