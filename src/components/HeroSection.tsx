  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="flex justify-center mb-2 sm:mb-3 md:mb-4 animate-fade-up" style={{ marginTop: '-1.0rem' }}>
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-bold text-background mb-4 animate-fade-up" style={{ marginTop: '-1.7rem' }}>
          Discover Egypt with{" "}
